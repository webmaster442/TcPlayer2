    ...
    internal static class Parser
    {
        ...
        public static string ParseStringValue(this XElement track, string keyValue)
        {
            return (from key in track.Descendants("key")
                    ...
                    select (key.NextNode as XElement)?.Value).FirstOrDefault() ?? string.Empty;
        }
        ...
        public static ITunesTrack? CreateTrack(XElement trackElement, bool exludeNotExistingFiles)
        {
